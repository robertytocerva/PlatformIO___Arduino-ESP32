...
{
  /*
  Si la presión es baja y la humedad alta, indica "Probabilidad de lluvia".
  Si la presión es alta y la humedad baja, indica "Clima despejado".
  Si la temperatura es baja, indica "Clima frío".
  Si la temperatura es alta, indica "Clima cálido".
  En otros casos, indica "Clima templado".
   */
